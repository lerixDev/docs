---
title: "Angular — الإشعارات"
description: "أعِدّ تسليم الإشعارات عبر Web Push القياسي (VAPID) لتطبيق Angular الخاص بك — بدون Firebase، بدون OneSignal."
---

## مقدمة

يُرسِل Atelerix الإشعارات إلى تطبيقات Angular باستخدام **بروتوكول Web Push
...
```bash
cp node_modules/lerix/sw/lerix-sw.js your-app/public/lerix-sw.js
```
