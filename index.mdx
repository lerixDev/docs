...
<CardGroup cols={3}>
  ...
  <Card title="Angular" icon="angular" href="/frameworks/angular/installation">
    Add Atelerix to your Angular app — error tracking and Web Push, no Flutter required.
  </Card>
  <Card title="Swift" icon="swift" href="/frameworks/ios/installation">
    Add Atelerix to your native iOS app — no Flutter required.
  </Card>
  <Card title="Kotlin" icon="android" href="/frameworks/android/installation">
    Add Atelerix to your native Android app — no Flutter required.
  </Card>
