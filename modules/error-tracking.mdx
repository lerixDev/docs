...
<CardGroup cols={2}>
  ...
  <Card title="iOS (Swift)" icon="swift" href="/frameworks/ios/error-tracking">
    Automatic crash capture and manual error reporting in a native iOS app.
  </Card>
  <Card title="NestJS (backend)" icon="node-js" href="/frameworks/nestjs/error-tracking">
    Automatic reporting of unhandled exceptions in a NestJS API, with request context.
  </Card>
</CardGroup>
