---
title: "Next.js — Push Notifications"
description: "Configure standard Web Push (VAPID) delivery for your Next.js app — no Firebase, no OneSignal required."
---

## Introduction

Lerix delivers push notifications to Next.js apps using the standard
...
After you complete the [Next.js installation](/frameworks/nextjs/installation),
follow the steps below to enable push delivery.

<Note>
  Make sure your app is wrapped in `LerixNextProvider` before configuring push notifications.
</Note>
...
import { useLerixNotifications } from 'lerix-nextjs';
