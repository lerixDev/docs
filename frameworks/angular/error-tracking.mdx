...
description: "Report errors and automatically capture uncaught exceptions from your Angular app to the Atelerix dashboard."
---

## Introduction

Atelerix captures errors from your Angular app so you can debug issues
...
Then open your [dashboard](https://app.atelerix.com) — the error should appear within seconds, with a resolved stack trace pointing at this exact line.
