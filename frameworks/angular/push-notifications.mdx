...
description: "Configure standard Web Push (VAPID) delivery for your Angular app — no Firebase, no OneSignal required."
---

## Introduction

Atelerix delivers push notifications to Angular apps using the standard
