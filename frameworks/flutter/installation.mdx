...
description: "Add Lerix to your Flutter app in a few steps."
---
...
Add `lerix` to your `pubspec.yaml`:
...
Call `Lerix.init()` as early as possible — ideally at the top of `main()` in `main.dart`. Initialization sets up error monitoring and reporting. It does **not** initialize push notifications; call `Lerix.notifications.init()` separately when you need that module.
...
|-----------|------|----------|-------------|
| `url` | `String` | Yes | Your project URL (e.g. `https://api.lerix.dev`) |
