...
description: "Report errors and automatically capture uncaught exceptions from your React app to the Atelerix dashboard."
---

## Introduction

Atelerix captures errors from your React app so you can debug issues
